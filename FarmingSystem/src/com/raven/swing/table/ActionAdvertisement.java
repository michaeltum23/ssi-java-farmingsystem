...
public class ActionAdvertisement extends javax.swing.JPanel {

    public ActionAdvertisement(ModelActionAdvertisement data) {
        initComponents();
        cmdEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().update(data.getAdvertisement());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().delete(data.getAdvertisement());
            }
        });
    }
