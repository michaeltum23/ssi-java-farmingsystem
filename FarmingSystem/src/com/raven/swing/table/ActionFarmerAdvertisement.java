...
public class ActionFarmerAdvertisement extends javax.swing.JPanel {

    public ActionFarmerAdvertisement(ModelActionFarmerAdvertisement data) {
        initComponents();
        cmdEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().offer(data.getAdvertisement());
            }
        });
    }
