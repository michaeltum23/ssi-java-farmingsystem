...
public class ActionSupplierComplain extends javax.swing.JPanel {

    public ActionSupplierComplain(ModelActionSupplierComplain data) {
        initComponents();
        cmdEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().update(data.getComplain());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().delete(data.getComplain());
            }
        });
    }
