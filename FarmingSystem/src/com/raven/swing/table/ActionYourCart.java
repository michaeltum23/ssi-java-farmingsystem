...
public class ActionYourCart extends javax.swing.JPanel {

    public ActionYourCart(ModelActionYourCart data) {
        initComponents();
        cmdEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().Add(data.getOrder());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().Minus(data.getOrder());
            }
        });
        cmdRemove.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().RemoveCart(data.getOrder());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        cmdRemove = new com.raven.swing.Button();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(cmdRemove, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private com.raven.swing.Button cmdRemove;
