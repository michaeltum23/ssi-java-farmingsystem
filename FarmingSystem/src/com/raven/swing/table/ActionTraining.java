...
public class ActionTraining extends javax.swing.JPanel {

    public ActionTraining(ModelActionTraining data) {
        initComponents();
        cmdEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEventActionTraning().update(data.getTraining());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEventActionTraning().delete(data.getTraining());
            }
        });
    }
