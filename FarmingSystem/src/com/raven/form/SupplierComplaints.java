...
public class SupplierComplaints extends javax.swing.JPanel {
    ...
    private void initCardData() {
        ...
        supplierCard1.setData(new ModelCard("Complaints", 5100, 20, icon1));
        Icon icon2 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.MONETIZATION_ON, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        supplierCard2.setData(new ModelCard("View Complaints", 2000, 60, icon2));
        Icon icon3 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        supplierCard3.setData(new ModelCard("Delete\n" +"Complaints", 3000, 80, icon3));
        Icon icon4 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.BUSINESS_CENTER, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        supplierCard4.setData(new ModelCard("Status Complaints", 550, 95, icon4));
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Complaints History");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Compla", "Course", "Fees", "Action"
            }
        ) {
