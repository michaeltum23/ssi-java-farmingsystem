 ...
 * @author jtamayo
 */
public class MakeOfferAdvertisement1 extends javax.swing.JFrame {
    /**
     * Creates new form SupplierDetails
     */
    
    public MakeOfferAdvertisement1() {
        initComponents();
    ...
    private void offerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_offerButtonActionPerformed
        ...
        try {
            ...
            Logger.getLogger(MakeOfferAdvertisement1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MakeOfferAdvertisement1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MakeOfferAdvertisement1().setVisible(true);
            }
        });
    }
