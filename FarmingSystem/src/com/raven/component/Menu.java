...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        if (user.getUserType().equals("Admin")) {
            ...
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/complaints.png")), "Complaints"));
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/complaints.png")), "ABOUT THE APPLICATION"));
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/complaints.png")), "SUMMARY OF PRODUCTS"));
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("")), ""));
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("")), ""));  
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("")), ""));
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("")), ""));
