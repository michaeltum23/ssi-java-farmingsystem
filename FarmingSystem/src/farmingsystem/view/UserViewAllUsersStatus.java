 ...
 * @author MY-PC
 */
public class UserViewAllUsersStatus extends javax.swing.JFrame {

    /**
     * Creates new form ViewUsers
     */
    public UserViewAllUsersStatus() {
        initComponents();
        AllUsers();
    ...
    private void initComponents() {
        ...
        filterbtn.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Status", "Active User", "Deactive User" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserViewAllUsersStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserViewAllUsersStatus().setVisible(true);
            }
        });
    }
